...
import { NETWORKS, ADDRESSES } from '../privateKeys.js';
...
const addressWETH = ADDRESSES.weth; // WETH Contract
...
const addressDAI = ADDRESSES.dai // DAI Contract
const contractDAI = new ethers.Contract(addressDAI, abiERC20, provider)

const account = "vitalik.eth";
...
const main = async () => {
    ...
    const balanceWETH = await contractWETH.balanceOf(account)
    ...
    const balanceDAI = await contractDAI.balanceOf(account)
